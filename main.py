...
def popup_get_date(start_mon=None, start_day=None, start_year=None, begin_at_sunday_plus=0, no_titlebar=True, title='Choose Date',  keep_on_top=True, location=(None, None), close_when_chosen=False, icon=None, locale=None, month_names=None, day_abbreviations=None):
    ...
    ############## CALENDAR 1 ###############
    calendarLayout_1 = [[sg.B('◄◄', font=arrow_font, border_width=0, key='-YEAR-DOWN-CAL1-', pad=((10,2),2)),
    ...
    calendarLayout_2 = [[sg.B('◄◄', font=arrow_font, border_width=0, key='-YEAR-DOWN-CAL2-', pad=((10,2),2)),
                ...
                sg.Text('{} {}'.format(mon_names[cur_month - 1], cur_year), size=(16, 1), justification='c', font=mon_year_font, key='-MON-YEAR-CAL2-', pad=(0,2)),
    ...
    ############## CALENDAR 2 ###############
    layout = [[calendarLayout_1 , calendarLayout_2]]
    ...
    update_days(window, cur_month, cur_year, begin_at_sunday_plus,2)
